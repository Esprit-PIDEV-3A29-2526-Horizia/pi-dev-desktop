...
public class GoogleOAuthController {
    ...
    private static final String CLIENT_ID = ""; // À remplacer par une variable d'env
    private static final String CLIENT_SECRET = ""; // À remplacer par une variable d'env    private static final String CLIENT_SECRET = ""; // À remplacer par une variable d'environnement
