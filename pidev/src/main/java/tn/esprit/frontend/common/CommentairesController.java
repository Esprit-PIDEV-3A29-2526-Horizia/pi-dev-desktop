...
public class CommentairesController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        // Pré‑remplir le champ auteur si connecté
        if (SessionManager.isLoggedIn()) {
            User user = SessionManager.getCurrentUser();
            String nomComplet = user.getPrenom() + " " + user.getNom(); // ou user.getNomComplet() si disponible
            System.out.println("👤 Utilisateur connecté : " + nomComplet);
    ...
    private VBox creerCarteCommentaire(Commentaire c) {
        ...
        if (SessionManager.isLoggedIn()) {
            ...
            boolean memeUtilisateur = currentUser.getId() == c.getUtilisateurId();
            boolean admin = SessionManager.isAdmin();
            peutAgir = memeUtilisateur || admin;
        }
    ...
    private void ajouterCommentaire() {
        ...
        c.setUtilisateurId(currentUser.getId());
    ...
    private boolean peutModifierOuSupprimer(Commentaire c) {
        ...
        User currentUser = SessionManager.getCurrentUser();
        return currentUser.getId() == c.getUtilisateurId() || SessionManager.isAdmin();
    }
