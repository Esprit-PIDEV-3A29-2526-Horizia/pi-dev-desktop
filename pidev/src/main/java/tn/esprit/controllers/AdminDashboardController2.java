...
public class AdminDashboardController2 implements Initializable {

    private static AdminDashboardController2 instance;
    ...
    private void setupInterface() {
        User currentUser = SessionManager.getUtilisateur();
        if (currentUser != null) {
    ...
    public static AdminDashboardController2 getInstance() { return instance; }
}