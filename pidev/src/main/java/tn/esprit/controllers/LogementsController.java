...
public class LogementsController implements Initializable {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        sortComboBox.setValue("Tarif croissant");
        ...
        addButton.setOnAction(event -> AdminDashboardController.loadPage("/fxml/ajoutLogement.fxml"));
    }
    ...
    private VBox createLogementCard(logement logement) {
        ...
        // Bouton Voir détails - CORRECTION ICI
        ...
        detailsBtn.setOnAction(e -> {
            // Utiliser AdminDashboardController au lieu de Dashboard
            AdminDashboardController.setSelectedLogement(logement);
            AdminDashboardController.loadPage("/fxml/DetailsLogement.fxml");
        });
