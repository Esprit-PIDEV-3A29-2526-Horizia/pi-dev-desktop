...
public class QRCodeService {
    ...
    public static String buildQRContent(int locationId, String nomClient,
    ...
    public static BufferedImage genererQRCodeImage(String contenu) throws WriterException {
    ...
    public static BufferedImage ajouterCadreHorizia(BufferedImage qrImage, int locationId) {
        int padding = 20;
        int headerH = 50;
        int footerH = 40;
